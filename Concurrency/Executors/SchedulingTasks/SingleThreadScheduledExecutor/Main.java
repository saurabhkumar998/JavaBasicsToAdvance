package Concurrency.Executors.SchedulingTasks.SingleThreadScheduledExecutor;
...
public class Main {
	public static void main(String[] args) {
		...
		singleThreadScheduledExecutor.schedule(() -> System.out.println(ZonedDateTime.now().format(dtf)), 2, TimeUnit.SECONDS);
